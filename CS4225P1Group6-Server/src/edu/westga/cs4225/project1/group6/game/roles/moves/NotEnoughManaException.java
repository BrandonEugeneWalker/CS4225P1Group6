...
/**
 * An exception that is thrown when an entity attemps to perform a move without
 * enough mana.
 * 
...
public class NotEnoughManaException extends RuntimeException {
	...
	public NotEnoughManaException(Entity caster, Move attemptedMove) {
		super("Current Mana: " + caster.getManaRemaining() + ". Move Cost: " + attemptedMove.getManaCost()
				+ ". Not Enough Mana.");
	}
}
